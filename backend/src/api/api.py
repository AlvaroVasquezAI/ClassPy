...
from .endpoints import teacher, subject, group, schedule, topic, student, qr_code, download, google_auth, classroom
...
api_router.include_router(google_auth.router, prefix="/api", tags=["auth"])
